...
if (isset($_GET['id'])) {
  ...
  $post_query = '
    ...
    COUNT(p.id) AS count_posts, post_type, name_class_icons, title, content_text, author_quotes, picture, video, href, p.user_id, login, name_class_icons, avatar, count_views,
